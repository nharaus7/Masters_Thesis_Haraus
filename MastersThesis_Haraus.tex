...
\titlespacing{\chapter}{0in}{-20pt}{0.1in}
\titlespacing{\section}{0in}{0in}{0.1in}
\titlespacing{\subsection}{0in}{0in}{0.1in}
...
\addcontentsline{toc}{chapter}{APPENDIX A: RAY-CIRCLE INTERSECTION ALGORITHM}
\begin{noindent}
...
\newpage
\setcounter{chapter}{9}
\addcontentsline{toc}{chapter}{APPENDIX B: POINT IN POLYGON ALGORITHM}
\begin{noindent}
